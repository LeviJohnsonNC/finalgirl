...
NEVER use the name of any real actor, director, or public figure (e.g. no "Nancy Allen",
"Donald Pleasence", "Tom Holland"). Use the Final Girl and killer names as the stars, and invent
plainly fictional names for the rest of the billing block (e.g. "MARA VOSS", "DIRECTED BY R.J. CRAVEN").`;
};
